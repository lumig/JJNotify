...
- (void)setJjNotifyStrategy:(NSMutableDictionary *)jjNotifyStrategy
{
    objc_setAssociatedObject(self, @selector(jjNotifyStrategy), jjNotifyStrategy, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    
}

- (NSMutableDictionary*)jjNotifyStrategy
{
